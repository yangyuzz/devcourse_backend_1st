...
public class TestHash {
	public static void main(String[] args) {
		String msg = "Hello programmers zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz";
		System.out.println("MD5 : " + testMD5(msg) +"//"+testMD5(msg).length());
		System.out.println("SHA512 : " + testSHA256(msg)+"//"+testSHA256(msg).length());
